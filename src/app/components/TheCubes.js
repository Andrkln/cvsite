...
export const Cube1 = () => {
    const cubeFaces = [
      { color: 'black', width: '43ch', height: '43ch', font: '16px', transform: 'rotateY(0deg) translateZ(21.5ch)', 
      ...
      speed: 45 },
      { color: 'rgb(74, 1, 245)', width: '43ch', height: '43ch', font: '16px', transform: 'rotateY(180deg) translateZ(21.5ch)', 
      ...
      speed: 100 },
      { color: 'orange', width: '43ch', height: '43ch', font: '16px', transform: 'rotateY(90deg) translateZ(200px)', 
      ...
      speed: 90 },
      { color: 'rgb(81, 196, 148)', width: '43ch', height: '43ch', font: '16px', transform: 'rotateY(-90deg) translateZ(21.5ch)', 
      ...
      speed: 60},
      { color: 'blue', width: '43ch', height: '43ch', font: '16px', transform: 'rotateX(90deg) translateZ(21.5ch)', 
      text: 'Only one css file', 
      TypeText:'Styling all project',
      imageUrl: img5,
      textColour: 'rgb(245, 1, 245)', 
      speed: 100 },
      { color: 'orange', width: '43ch', height: '43ch', font: '16px', transform: 'rotateX(-90deg) translateZ(21.5ch)',},
    ];
...
export const Cube2 = () => {
const cubeFaces = [
    { color: 'lightblue', width: '400px', height: '400px', font: '16px', transform: 'rotateY(0deg) translateZ(200px)',
    text: 'A telegram bot, my personal helper', 
    TypeText:'Has Postgres SQL database',
    imageUrl: img6,
    textColour: 'rgb(245, 1, 245)', 
    speed: 70 },
    { color: 'gray', width: '400px', height: '400px', font: '16px', transform: 'rotateY(180deg) translateZ(200px)', 
    ...
    speed: 40 },
    { color: 'yellow', width: '400px', height: '400px', font: '16px', transform: 'rotateY(90deg) translateZ(200px)', 
    ...
    speed: 50 },
    { color: 'rgb(45, 136, 255)', width: '400px', height: '400px', font: '16px', transform: 'rotateY(-90deg) translateZ(200px)', 
    text: '2 python shedule libraries', 
    TypeText:'Manage any type of event' ,
    imageUrl: img9,
    textColour: 'rgb(230, 241, 63)',  
    speed: 50},
    { color: 'violet', width: '400px', height: '400px', font: '16px', transform: 'rotateX(90deg) translateZ(200px)', 
    text: 'Data presented', 
    TypeText:'In a simple way',
    imageUrl: img10,
    textColour: 'rgb(2, 146, 62)', 
    speed: 50 },
    { color: 'orange', width: '400px', height: '400px', font: '16px', transform: 'rotateX(-90deg) translateZ(200px)',},
];
...
export const Cube3 = () => {
const cubeFaces = [
    { color: 'rgb(21, 129, 66)', width: '400px', height: '400px', font: '16px', transform: 'rotateY(0deg) translateZ(200px)',
    text: 'Google sheets as a database', 
    TypeText:'Manages data easily',
    imageUrl: img10,
    textColour: 'rgb(252, 237, 172)', 
    speed: 50 },
    { color: 'rgb(45, 136, 255)', width: '400px', height: '400px', font: '16px', transform: 'rotateY(180deg) translateZ(200px)', 
    text: 'Different communication mods', 
    TypeText:'Personal and Group',
    imageUrl: img11,
    textColour: 'rgb(0, 23, 124)', 
    speed: 50 },
    { color: 'rgb(42, 111, 201)', width: '400px', height: '400px', font: '16px', transform: 'rotateY(90deg) translateZ(200px)', 
    text: 'Messages filter', 
    TypeText:'Smart adding of tasks',
    imageUrl: img12,
    textColour: 'rgb(0, 23, 124)', 
    speed: 50 },
    { color: 'rgb(39, 194, 255)', width: '400px', height: '400px', font: '16px', transform: 'rotateY(-90deg) translateZ(200px)', 
    text: 'Fast tasks management', 
    TypeText:'Add or Delete within seconds' ,
    imageUrl: img13,
    textColour: 'black',  
    speed: 50},
    { color: 'rgb(189, 189, 189)', width: '400px', height: '400px', font: '16px', transform: 'rotateX(90deg) translateZ(200px)', 
    text: 'A great design', 
...
const cubeFaces = [
    ...
    textColour: 'black',  
    speed: 50 },
    { color: 'red', width: '400px', height: '400px', font: '16px', transform: 'rotateY(180deg) translateZ(200px)', 
    text: 'Page for kuzetkorgau', 
    TypeText:'Modern design for old website',
    imageUrl: img16,
    textColour: 'yellow',  
    speed: 50 },
    { color: 'green', width: '400px', height: '400px', font: '16px', transform: 'rotateY(90deg) translateZ(200px)', 
    text: 'Small studying projects', 
    TypeText:'Mousetracker, calculator etc',
    imageUrl: img17,
    textColour: 'white', 
    speed: 50 },
    { color: 'purple', width: '400px', height: '400px', font: '16px', transform: 'rotateY(-90deg) translateZ(200px)', 
    text: 'Yandex and Google marketing', 
    TypeText:'SEO, SEM...' ,
    imageUrl: img18,
    textColour: 'rgb(31, 109, 255)', 
    speed: 50},
    { color: 'rgb(0, 153, 255)', width: '400px', height: '400px', font: '16px', transform: 'rotateX(90deg) translateZ(200px)', 
...
export const Cube5 = () => {
const cubeFaces = [
    { color: 'rgb(0, 153, 255)', width: '400px', height: '400px', font: '16px', transform: 'rotateY(0deg) translateZ(200px)',
    text: 'Telegram bot for customers', 
    TypeText:'Shows real time balance',
    imageUrl: img20,
    textColour: 'rgb(11, 13, 121)', 
    speed: 50 },
    { color: 'pink', width: '400px', height: '400px', font: '16px', transform: 'rotateY(180deg) translateZ(200px)', 
    text: 'Communicate any with department of the company', 
    TypeText:'Within one simple chat',
    imageUrl: img21,
    textColour: 'rgb(255, 66, 214)', 
    speed: 50 },
    { color: 'rgb(121, 11, 11)', width: '400px', height: '400px', font: '16px', transform: 'rotateY(90deg) translateZ(200px)', 
    text: 'All the discounts', 
    TypeText:'that compay offers now',
    imageUrl: img24,
    textColour: 'rgb(255, 66, 214)',  
    speed: 50 },
    { color: 'rgb(89, 0, 255)', width: '400px', height: '400px', font: '16px', transform: 'rotateY(-90deg) translateZ(200px)', 
    text: 'Styled buttons', 
...
export const Cube6 = () => {
const cubeFaces = [
    { color: 'rgb(166, 255, 0)', width: '400px', height: '400px', font: '16px', transform: 'rotateY(0deg) translateZ(200px)',
    text: 'This website developed with Next.js and Python', 
    TypeText:'Next.js + Django rest',
    imageUrl: img25,
    textColour: 'green',
    speed: 50 },
    { color: 'rgb(211, 211, 211)', width: '400px', height: '400px', font: '16px', transform: 'rotateY(180deg) translateZ(200px)', 
    text: 'A samrt chat bot will answer any questions', 
    TypeText:'About me or my projects',
    imageUrl: img26,
    textColour: 'black', 
    speed: 50 },
    { color: 'linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(14,14,215,1) 35%, rgba(0,212,255,1) 100%)', width: '400px', height: '400px', font: '16px', transform: 'rotateY(90deg) translateZ(200px)', 
    text: 'Special styled text', 
    TypeText:'Looks better and more memorable',
    imageUrl: img27,
    textColour: 'pink',  
    speed: 50 },
    { color: 'blue', width: '400px', height: '400px', font: '16px', transform: 'rotateY(-90deg) translateZ(200px)', 
    text: 'This website has', 
    TypeText:'Complex 3D animations',
    imageUrl: img28,
    textColour: 'grey',   
    speed: 50},
    { color: ' #8181b6', width: '400px', height: '400px', font: '16px', transform: 'rotateX(90deg) translateZ(200px)', 
