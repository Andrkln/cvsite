...
export const Cube1 = () => {
    const cubeFaces = [
      { color: 'black', width: '400px', height: '400px', font: '16px', transform: 'rotateY(0deg) translateZ(200px)', 
      ...
      speed: 45 },
      { color: 'rgb(74, 1, 245)', width: '400px', height: '400px', font: '16px', transform: 'rotateY(180deg) translateZ(200px)', 
      ...
      speed: 100 },
      { color: 'orange', width: '400px', height: '400px', font: '16px', transform: 'rotateY(90deg) translateZ(200px)', 
      ...
      speed: 90 },
      { color: 'rgb(81, 196, 148)', width: '400px', height: '400px', font: '16px', transform: 'rotateY(-90deg) translateZ(200px)', 
      ...
      speed: 60},
      { color: 'blue', width: '400px', height: '400px', font: '16px', transform: 'rotateX(90deg) translateZ(200px)', 
...
const cubeFaces = [
    ...
    text: 'Communicate with department of the company', 
...
const cubeFaces = [
    ...
    text: 'This website developed with React and Python', 
    TypeText:'Node.js + Django rest',
    imageUrl: img25,
    textColour: 'green',
    speed: 50 },
    ...
    textColour: 'grey',   
    speed: 50},
    { color: 'black', width: '400px', height: '400px', font: '16px', transform: 'rotateX(90deg) translateZ(200px)', 
